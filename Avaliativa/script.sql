...
create index idx_fcodigo on tbl_fornecimento(icodigo);
create index idx_pcodigo on tbl_fornecimento(icodigo);
create index idx_pcodigo on tbl_fornecimento(icodigo);

show index from tbl_projeto;
show index from tbl_fornecimento;

-- use transporte_sa,
-- select database(),

-- exclusao da tabela instituicao
-- alter table -- drop table 

-- alter table tbl-fornecedor
...
-- insert into tbl_cidade values (12,'Indaiatuba','SP');
-- insert into tbl_cidade values (13,'Barao','SP');
-- insert into tbl_cidade values (14,'Minas Gerais','SP');
